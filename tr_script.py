...
def run_pylupdate():
    try:
        subprocess.run(
            [
                "pylupdate6.exe",
                "./src/mousereactivergb.py",
                "./src/mousereactivergb.ui",
                "-ts",
                f"./src/resources/tr/{PROJECT}_fr.ts",
                "-ts",
                f"./src/resources/tr/{PROJECT}_de.ts",
                "-ts",
                f"./src/resources/tr/{PROJECT}_es.ts",
                "-ts",
                f"./src/resources/tr/{PROJECT}_en.ts",
            ],
            check=True,
        )
