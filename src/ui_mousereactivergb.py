...
class Ui_MouseReactiveRGB(object):
    def setupUi(self, MouseReactiveRGB):
        ...
        MouseReactiveRGB.resize(303, 435)
        ...
        self.fpsSpinBox.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.gridLayout_3.addWidget(self.startstopButton, 7, 0, 1, 3)
        self.autostartCheckBox = QtWidgets.QCheckBox(parent=self.frame_2)
        ...
        self.gridLayout_3.addWidget(self.autostartCheckBox, 6, 2, 1, 1)
